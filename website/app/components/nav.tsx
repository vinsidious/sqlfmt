    ...
    <nav className="sticky top-0 z-50 border-b border-white/[0.04] bg-[#050505]/80 backdrop-blur-xl">
      <div className="mx-auto flex h-14 max-w-7xl items-center justify-between px-4 sm:px-6">
        <Link href="/" className="group">
          <span className="font-mono text-sm font-semibold text-zinc-200 tracking-tight transition-colors duration-200 group-hover:text-white">
            holywell
          </span>
        </Link>
        ...
        <div className="flex items-center gap-1">
          ...
          <a
            ...
            className="ml-3 text-zinc-600 transition-colors duration-200 hover:text-zinc-300"
            aria-label="GitHub"
          >
            <svg
